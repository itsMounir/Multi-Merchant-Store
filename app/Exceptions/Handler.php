...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception|Throwable $e)
    {
        ...
        if ($e instanceof PusherException) {
            ...
            return response()->json('.حدث خطأ ما، حاول مرة أخرى لاحقًا', 500);
        }
        ...
        if ($e instanceof ConnectionException) {
            ...
            return response()->json('.حدث خطأ ما، حاول مرة أخرى لاحقًا', 503);
        }
        ...
        if ($e instanceof JobTimeoutException) {
            ...
            return response()->json('.حدث خطأ ما، حاول مرة أخرى لاحقًا', 504);
        }
